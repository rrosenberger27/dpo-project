...
Two saved folders for the sft adapters and dpo adapters. Commands in notebook for merging the sft adapters with the base model (for then using dpo adapters with), but merged model stored in drive for now.
